app.component('action-dialog', {
    ...
    template: `
        <div :class="['moduleDialog', itemClass]">
            ...
            <div v-if="!displayEndResult" class="absolute top-4 right-4 p-1 rounded-full w-8 h-8 bg-main shadow-oda flex justify-center items-center cursor-pointer" @click="dialog=false"><oda-icon class="" name="fxemoji:cancellationx"></oda-icon></div>
