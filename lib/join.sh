...
cd ../ &&
cd components/ &&
terser OdaTitulo.js OdaInstruccion.js OdaIcon.js OdaFinalizar.js Utilities.js LayoutGrid.js LayoutBox.js LayoutImg.js ModuleCheck.js ModuleDrag.js ModuleInput.js ModuleSelect.js ModuleChoice.js ModuleCustomCode.js ActionRepeater.js ActionDelay.js ActionTimeline.js AVStart.js AVEnd.js AVScene.js AVInfo.js AVActivity.js AVScorebox.js AVButton.js  --compress --timings -o ../components.js &&
echo 'End'
