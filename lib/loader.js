...
const components = [
    ...
    path+'components/ActionVariable.js',
    path+'components/ActionConditional.js',
...
function loadScript() {
    ...
    nsc.setAttribute('src', scripts[currentJS] + '?v='+Math.round(Math.random()*9999))
...
for(let style of styles){
    ...
    sty.rel = style.rel
    sty.href= style.url
    sty.setAttribute('crossorigin' , "anonymous")
